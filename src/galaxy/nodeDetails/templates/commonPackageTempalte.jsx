    ...
    <div className='container-fluid row'>
      <div className='hidden-xs'>
        ...
        <div className="col-xs-3">
          <div className="row">
            <h2 id={model.name} className='in-degree'>{model.inDegree}</h2>
          </div>
          <div className="row small">{model.inDegreeLabel}</div>
        </div>
        <div className="col-xs-3">
          <div className="row">
            <h2 id={model.name} className='out-degree'>{model.outDegree}</h2>
          </div>
      ...
      <div className='visible-xs-block'>
        <div className='row info-block'>
          ...
          <div id={model.name} className='in-degree col-xs-3'>{model.inDegree}</div>
          <div id={model.name} className='out-degree col-xs-3'>{model.outDegree}</div>
        </div>
      </div>
    </div>
  );
