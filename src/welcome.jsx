  ...
  render() {
    return (
      <div className='container'>
        <h1>Welcome to the Data Galaxy, Commander</h1>
        ...
        <div className='media-list'>
          ...
          <Destination description='A Random Graph generated by Brady'
                      href='#/galaxy/randomgraph?l=1'
          ...
          <Destination description='A graph generated from celegans.gexf by Brady'
                      href='#/galaxy/celegans?l=1'
                      media='brew_fly_first.png'
                      name='C. Elegans'/>

          <Destination description='A 3D visualization of an AML Protien Network'
                      href='#/galaxy/cryo?cx=0&cy=0&cz=3678&lx=0.0000&ly=0.0000&lz=0.0000&lw=1.0000&ml=150&s=1.75&l=0&v=data'
                      media='brew_fly_first.png'
                      name='AML Proteins'/>
        </div>
      </div>
